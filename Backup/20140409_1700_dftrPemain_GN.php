...
<?php
	...
	if(isset($_POST['ftxtNoStaff'])){ $notaf = $_POST['ftxtNoStaff']; };
...
<div id="container">
    ...
    <form name="frmDaftar_N_G" id="frmDaftar_N_G" action ="dftrPemain_GN.php" method="post">
        <table width="98%" id="Main" align="center">
            <tr>
                <td>
            ...
            <tr>
                <td>
					...
					<tr>
						...
						<td width="1%">:</td>
						<td width="45%">
                            <input type="text" name="ftxtNama" id="ftxtNama" maxlength="60" style="width:450px;">
						</td>
					...
					<tr>
						...
						<td>:</td>
						<td>
							<input type="text" name="ftxtIC" id="ftxtIC" maxlength="20" style="width:150px;" onkeypress="return numeric_only(event);">
						...
						<td>:</td>
						<td>
							<input type="text" name="ftxtNotel" id="ftxtNotel" maxlength="20" style="width:120px;">
						</td>
					</tr>
                    <tr>
                        ...
                        <td></td>
                        <td>
							<input type="text" name="ftxtEmel" id="ftxtEmel" maxlength="100" style="width:450px;">
						</td>
                        <td colspan="3">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
							<input type="text" name="ftxtNoTelPej" id="ftxtNoTelPej" maxlength="20" style="width:120px;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input name="fstatus" type="radio" id="fstatus" value="TETAP" />TETAP
                            <input name="fstatus" type="radio" id="fstatus" value="KONTRAK" />KONTRAK 
						</td>
                        <td>No. Faks.</td>
                        <td>:</td>
                        <td>
							<input type="text" name="ftxtNoFaks" id="ftxtNoFaks" maxlength="20" style="width:120px;">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6">&nbsp;</td>
