...
function Simpan()
	{
		...
		if ($StaSave =="save")
		{
			...
			{			
				for ($i=1; $i<=$jum_f; $i++)
				{
					$rs1 = mydb ("INSERT INTO FlightD1 (a.F_ID, b.H_ID)
...
<tr>
    <td>
    <form name="frmFlight" id="frmFlight" action ="holeflight.php" method="post">
							...
							<div class=listbox style="height:400px">
                                ...
                                ?>
                                           <tr class="listoff" style="background-color:#FFF">
                                                ...
                                                <td width="39%" valign="middle"><?php echo $objResult["F_ID"] ;?></td>
