...
if (isset($_POST['cmbPadang'])) {
    $idpadang = $_POST['cmbPadang'];
};
                ...
                <table width="100%" id="Main" align="center">
                    <tr>
                        ...
                        <td width="10%" align="left" style="font-size:17px"><a href="menuUtiliti.php"><img
                                    src="image/Settings-icon.png" alt="" width="100" height="25"/></a></td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" align="center">
                                            ...
                                            while ($row) {
                                                if ($idpadang == $row['P_ID']) {
                                                    ...
                                                    <option value="<?php echo $row['P_ID']; ?>"
                                                            selected="selected"><?php echo $row['P_Nama']; ?></option>
                                                <?php
                                                } else {
                                                    ?>
                                                    <option
                                                        value="<?php echo $row['P_ID']; ?>"><?php echo $row['P_Nama']; ?></option>
                                                <?php
                                                }
                                                $row = odbc_fetch_array($result);
                                            }
                            ...
                            <table width="100%" align="center">
                                <tr valign="top">
                                    <td>
                                        <table id="TableB" border="0" width="100%">
                                            <tr class="theader">
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <div class=listbox style="height:300px">
                                                        <table id="TableC" border="0" cellspacing="1" cellpadding="1"
                                                            ...
                                                            while ($objResult) {
                                                                ?>
                                                                <tr class="listoff"
                                                                    onMouseOver="this.className='liston';"
                                                                    onMouseOut="this.className='listoff';"
                                                                    ondblclick="PaparInfo(<?php echo $i; ?>,'TableC', '<?php echo $objResult["N_Kategori"]; ?>')">
