...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script type="text/javascript">
		...
		function PaparInfo(InfoInd, id) 
		{
			...
			document.frmDaftar_IPT.ftxtIC.value = document.getElementById(id).rows[InfoInd].cells[1].innerHTML;			
			document.frmDaftar_IPT.ftxtNama.value = document.getElementById(id).rows[InfoInd].cells[2].innerHTML;
			document.frmDaftar_IPT.fcmbSaiz.value = document.getElementById(id).rows[InfoInd].cells[4].innerHTML;	
			document.frmDaftar_IPT.ftxtNotel.value = document.getElementById(id).rows[InfoInd].cells[5].innerHTML;
			document.frmDaftar_IPT.hidKategori.value = document.getElementById(id).rows[InfoInd].cells[6].innerHTML;	
			document.frmDaftar_IPT.ftxtEmel.value = document.getElementById(id).rows[InfoInd].cells[8].innerHTML;	
			document.frmDaftar_IPT.ftxtGelaran.value = document.getElementById(id).rows[InfoInd].cells[9].innerHTML;	
			document.frmDaftar_IPT.ftxtJawatan.value = document.getElementById(id).rows[InfoInd].cells[10].innerHTML;	
			document.frmDaftar_IPT.ftxtNoStaff.value = document.getElementById(id).rows[InfoInd].cells[11].innerHTML;	
			document.frmDaftar_IPT.fstatus.value = document.getElementById(id).rows[InfoInd].cells[12].innerHTML;	
			document.frmDaftar_IPT.ftxtMulaKhidmat.value = document.getElementById(id).rows[InfoInd].cells[13].innerHTML;				
			document.frmDaftar_IPT.ftxtNoTelPej.value = document.getElementById(id).rows[InfoInd].cells[14].innerHTML;	
			document.frmDaftar_IPT.ftxtNoFaks.value = document.getElementById(id).rows[InfoInd].cells[15].innerHTML;	
		//	document.frmDaftar_IPT.ftxtNamaKelab.value = document.getElementById(id).rows[InfoInd].cells[16].innerHTML;	
//			document.frmDaftar_IPT.ftxtNoNHS.value = document.getElementById(id).rows[InfoInd].cells[17].innerHTML;	
//			document.frmDaftar_IPT.fcmbHandicap.value = document.getElementById(id).rows[InfoInd].cells[18].innerHTML;	
			document.frmDaftar_IPT.fjantina.value = document.getElementById(id).rows[InfoInd].cells[16].innerHTML;	
				
			document.frmDaftar_IPT.hidIC.value = document.getElementById(id).rows[InfoInd].cells[1].innerHTML;	
			document.frmDaftar_IPT.hidSave.value="update";
		}	

		function NewRekod()
		{
			document.frmDaftar_IPT.hidNew.value = "new";
			document.frmDaftar_IPT.hidSave.value = "";	
			
			document.frmDaftar_IPT.submit();
			return true;	
		}

		function SimpanRekod()
		{	
			if ((document.frmDaftar_IPT.ftxtNama.value == "") || (document.frmDaftar_IPT.ftxtNama.value == "-"))
			{
				alert("Sila pastikan ruangan 'Nama' tidak dibiarkan kosong.");
				document.frmDaftar_IPT.ftxtNama.focus();
				return false;
			}
		
			if ((document.frmDaftar_IPT.fcmbSaiz.value == "") || (document.frmDaftar_IPT.fcmbSaiz.value == "-"))
			{
				alert("Sila pastikan ruangan 'Saiz Baju' tidak dibiarkan kosong.");
				document.frmDaftar_IPT.fcmbSaiz.focus();
				return false;
			}
			
			if ((document.frmDaftar_IPT.ftxtIC.value == "") || (document.frmDaftar_IPT.ftxtIC.value == "-"))
			{
				alert("Sila pastikan ruangan 'No. Pengenalan' tidak dibiarkan kosong.");
				document.frmDaftar_IPT.ftxtIC.focus();
				return false;
			}

			if ((document.frmDaftar_IPT.ftxtNotel.value == "") || (document.frmDaftar_IPT.ftxtNotel.value == "-"))
			{
				alert("Sila pastikan ruangan 'No. Tel. Bimbit' tidak dibiarkan kosong.");
				document.frmDaftar_IPT.ftxtNotel.focus();
				return false;
			}
			
			if ((document.frmDaftar_IPT.ftxtEmel.value == "") || (document.frmDaftar_IPT.ftxtEmel.value == "-"))
			{
				alert("Sila pastikan ruangan 'Emel' tidak dibiarkan kosong.");
				document.frmDaftar_IPT.ftxtEmel.focus();
				return false;
			}

		
			
			if (document.frmDaftar_IPT.hidSave.value == "" )
			{			
				document.frmDaftar_IPT.hidSave.value = "save";
				document.frmDaftar_IPT.submit();
				return true;
			}
			else
		...
		function HapusRekod()
		{
			if (document.frmDaftar_IPT.hidSave.value != "" )
			{
				...
				{
					document.frmDaftar_IPT.hidDelete.value = "delete";
					document.frmDaftar_IPT.hidSave.value = "";
					document.frmDaftar_IPT.submit();
					return true;
				}
		...
		if ($StaSave =="save")
		{
			...
			else
			{
				$rs1 = mydb ("INSERT INTO PEMAIN (PE_Nama, PE_Gelaran, PE_ID, PE_Email, PE_NoHp, PE_Jantina, PE_SaizBaju, PE_Jawatan, PE_NoStaf,
								PE_StatusJwt, PE_TkhMulaKhidmat, PE_NoPej, PE_NoFax, Kat_ID)
							VALUES('$nama', '$gelaran', '$ic', '$emel', '$nohp', '$jantina', '$saiz', '$jawatan', '$nostaf',
								'$stajaw','$mulakhidmat','$nopej','$nofaks', '$kat')");
...
<tr>
    <td>
    <form name="frmDaftar_IPT" id="frmDaftar_IPT" action ="dftrPemain_JemIPT.php" method="post">
            ...
            <tr>
                <td>
                    ...
                    <tr>
						...
						<td>:</td>
						<td><label>
                          <input name="fKategori" type="text" id="fKategori" value="Jemputan IPTA" readonly="readonly"/> <input type="hidden" name="hidKategori" id="hidKategori" value="03"/>
